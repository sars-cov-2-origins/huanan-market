...
## drop all samples with negative PCR, but positive NGS
stall_to_remove = list('Q37','Q61','Q70')
...
same_stall=list(list('A14','A15','A90','A88','A87'),list('Q64','Q69','Q68'),list('A2','A18','A20'),list('F98','F100'),list('Q93','A61'))
...
h0 = 13.83643 # use bandwidth selected using cross-validation
pdf('relative_risk_pos_vs_all_noNegPCRs.pdf')
...
pal <- colorRampPalette(cols)
pdf('kde_all_stalls_noNegPCRs.pdf')
...
cols = c("#FFFFFF",cols)
pal <- colorRampPalette(cols)
pdf('kde_positives_sample_level_noNegPCRs.pdf')
